package com.akatsuki.discovery.configuration;
...
public class TestSecurityConfig {
    ...
    public SecurityFilterChain testSecurityFilterChain(HttpSecurity http, AsymmetricJwtUtil jwtUtil) throws Exception {
        http
                ...
                .addFilterBefore(new JwtAuthenticationFilter(jwtUtil, List.of("dicover/**")), UsernamePasswordAuthenticationFilter.class);
        return http.build();
    }
}