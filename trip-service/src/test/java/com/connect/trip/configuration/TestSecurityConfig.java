package com.akatsuki.trip.configuration;
...
public class TestSecurityConfig {
    ...
    public SecurityFilterChain testSecurityFilterChain(HttpSecurity http, AsymmetricJwtUtil jwtUtil) throws Exception {
        http
                ...
                .addFilterBefore(new JwtAuthenticationFilter(jwtUtil, List.of("connectors/**")), UsernamePasswordAuthenticationFilter.class);
        return http.build();
    }
}